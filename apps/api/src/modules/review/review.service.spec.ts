...
describe("ReviewService", () => {
  ...
  describe("create", () => {
    ...
    it("throws ForbiddenException when user has no COMPLETED booking for the tour", async () => {
      ...
      await expect(
        service.create("user-id-1", "tour-id-1", CREATE_DTO)
    ...
    it("throws NotFoundException when tour does not exist", async () => {
      ...
      await expect(
        service.create("user-id-1", "nonexistent-tour", CREATE_DTO)
  ...
  describe("update", () => {
    ...
    it("throws ForbiddenException when update is called by a non-owner", async () => {
      ...
      await expect(
        service.update("other-user-id", "review-id-1", { rating: 3 })
      ).rejects.toThrow(ForbiddenException);
  ...
  describe("remove", () => {
    ...
    it("throws ForbiddenException when remove is called by a non-owner", async () => {
      ...
      await expect(
        service.remove("other-user-id", "review-id-1")
      ).rejects.toThrow(ForbiddenException);
  ...
  describe("approve", () => {
    ...
    it("throws NotFoundException when review does not exist", async () => {
      ...
      await expect(
        service.approve("nonexistent-review", "admin-id-1")
      ).rejects.toThrow(NotFoundException);
