...
export default function Page() {
  return (
    <PageShell eyebrow="VIETWANDER AI" title="Admin AI Knowledge Studio">
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        <section className="rounded-2xl bg-white p-6 shadow-sm">
          <p className="text-lg text-navy/75">Upload markdown or JSON, reindex Qdrant, inspect retrieved docs, and hallucination guard logs.</p>
