...
- Dart format: passed for changed mobile booking, home, explore, destination detail, shell, and widget test files, with package-resolution warnings because Flutter SDK is not installed locally
