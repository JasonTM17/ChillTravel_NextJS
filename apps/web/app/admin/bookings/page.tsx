          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {['UNPAID', 'PAID', 'FAILED', 'REFUNDED'].map((s) => (
                ...
                >
                  {
                    { UNPAID: 'Chưa TT', PAID: 'Đã TT', FAILED: 'Thất bại', REFUNDED: 'Hoàn tiền' }[
                      s
                    ]
                  }
                </button>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center p-16 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Hiện tại không có dữ liệu phù hợp với bộ lọc.
            </p>
          </div>
        ) : (
              ...
              <tbody>
                {items.map((item) => (
                  <tr key={item.id} className="border-b last:border-0 hover:bg-gray-50">
                    <td className="px-4 py-3 font-mono text-xs font-bold text-tv-blue">
                      {item.bookingCode}
                    </td>
