...
const vi: TranslationNamespace = {
  ...
  home: {
    heroTitle: 'Đặt tour, khách sạn và vé máy bay dễ dàng',
    searchPlaceholder: 'Nhập điểm đến...',
    quickSearch: 'Tìm nhanh:',
    todayDeals: 'Ưu đãi hôm nay',
    viewAll: 'Xem tất cả',
    featuredTours: 'Tour nổi bật',
    featuredToursSubtitle: 'Các tour được đặt nhiều nhất',
    vietnamDestinations: 'Điểm đến Việt Nam',
    vietnamDestinationsSubtitle: 'Khám phá vẻ đẹp đất nước hình chữ S',
    worldDestinations: 'Điểm đến quốc tế',
    worldDestinationsSubtitle: 'Khám phá thế giới với WanderViet',
    allTours: 'Tất cả tour',
    allToursSubtitle: 'Tìm tour phù hợp với bạn',
    coupons: 'Mã giảm giá',
    demoPaymentNotice: '⚠️ Thanh toán demo',
    demoPaymentDesc: '— Không phát sinh giao dịch thật. Đây là nền tảng demo portfolio.',
    ...
    safePaymentDesc: 'Mã hóa SSL, không lưu thẻ thật',
    realData: 'Dữ liệu thật',
    realDataDesc: 'Tour và điểm đến từ backend thật',
    support247: 'Hỗ trợ 24/7',
    support247Desc: 'Trợ lý local, không cần cloud key',
    bestPrice: 'Giá tốt nhất',
    bestPriceDesc: 'Demo — không phát sinh giao dịch thật',
  },
};
