        ...
        children: [
          Container(
            ...
            child: const Column(
              ...
              children: [
                Text('Wishlist', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.w800)),
                SizedBox(height: 12),
                Text('Saved places, hotels, and experiences grouped by trip', style: TextStyle(color: Colors.white70, fontSize: 16)),
              ],
            ),
          ),
          ...
          const SizedBox(height: 20),
          FilledButton(onPressed: () => context.go('/profile'), child: const Text('Continue')),
        ],
      ),
    );
  }
