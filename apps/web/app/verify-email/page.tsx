    ...
    <div className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-[minmax(0,1fr)_340px]">
      <CommerceSurface>
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.14em] text-[tv-ink-3]">Xác thực email</p>
        ...
        <div className="mt-6">
          {state === "loading" && (
            <div className="flex items-center gap-3 rounded-tv border border-[tv-border] bg-[tv-bg] p-5 text-[tv-ink-3]">
              <Loader2 size={22} className="animate-spin shrink-0 text-[tv-blue]" aria-hidden="true" />
      ...
      <aside className="space-y-4">
        ...
        <CommerceSurface>
          ...
          <Link
            href="/login"
            className="mt-4 inline-flex font-bold text-[tv-blue] hover:underline"
          >
            Đăng nhập
          </Link>
        </CommerceSurface>
