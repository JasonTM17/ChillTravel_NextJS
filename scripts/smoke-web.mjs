...
const routes = [
  ...
  [
    ...
    ['Đà Nẵng', 'Ẩm thực', 'Tóm tắt chuyến đi'],
  ],
  ...
  ['/hotels', 'Khách sạn'],
  [
    '/hotels/da-nang-boutique-stay',
    ['Đà Nẵng Boutique Stay', 'Chọn phòng demo', 'Thanh toán demo'],
  ],
  ...
  [
    '/booking/da-nang',
    ['Thanh toán demo', 'không phát sinh giao dịch thật', 'Xem trước vé QR', 'CT-QR'],
  ],
