...
Create a high-fidelity admin operations console for VIETWANDER AI using the VietWander Travel Commerce design DNA.

**DESIGN SYSTEM (REQUIRED):**
- Brand: VietWander AI custom compass/route/Vietnam identity with Hoang Sa and Truong Sa. Do not use Traveloka bird, mark, wordmark, exact color proportions, or third-party assets.
...
**PAGE STRUCTURE:**
1. Sticky white header with VietWander logo and admin actions.
