...
export class DestinationsController {
  ...
  @ApiOperation({
    ...
    description:
      "Updates destination fields. Slug is regenerated only if name changes."
  })
  ...
  @ApiOperation({
    ...
    description:
      "Sets destination status to DELETED. The record is not removed from the database."
  })
  @ApiParam({ name: "id", description: "Destination ID" })
  ...
  addImage(
    @Param("id") id: string,
    @Body() dto: AddDestinationImageDto
  ) {
