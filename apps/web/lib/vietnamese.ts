...
const travelStyleDescriptions: Record<TravelStyle, string> = {
  'Food Hunter':
    'Bạn thường chọn điểm đến theo món ăn, chợ địa phương, quán cà phê và nhịp sống khu phố.',
  'Culture Seeker':
    'Bạn thích câu chuyện, di sản, kiến trúc, bảo tàng và cách một nơi vận hành trong đời sống hằng ngày.',
  'Beach Lover': 'Bạn cần biển, hoàng hôn, hải sản và khoảng nghỉ đủ mềm giữa các hoạt động.',
  'Mountain Adventurer':
    'Bạn tìm độ cao, cung đường đẹp, buổi sáng mát và những hành trình đáng công chuẩn bị.',
  'Luxury Escaper': 'Bạn ưu tiên ít di chuyển, nơi ở tốt, xe riêng và trải nghiệm được chọn lọc.',
  'Budget Backpacker':
    'Bạn tối ưu chi phí bằng phương tiện địa phương, nơi ở hợp lý và hoạt động giá trị cao.',
  'Family Planner':
    'Bạn cần nhịp đi an toàn, chỗ ở đáng tin, đồ ăn gần và kế hoạch có thể dùng offline.',
  'World Wanderer':
    'Bạn thích các biểu tượng toàn cầu, cảm hứng xuyên biên giới và lịch trình nhiều tương phản.',
};
  ...
  return {
    ...
    days: Array.from({ length: durationDays }, (_, index) => {
      ...
      return {
        ...
        title:
          day === 1
            ? `Đến ${copy.name} và làm quen nhịp địa phương`
            : `Ngày ${day} khám phá ${copy.name} theo nhịp cân bằng`,
        morning:
          day === 1
            ? ['Đến nơi, gửi hành lý và kiểm tra khu lưu trú mock', `Đi bộ nhẹ quanh ${copy.city}`]
            : [
                `Chọn một điểm nổi bật ở ${copy.city}`,
                'Giữ lịch buổi sáng thoáng để tránh quá tải',
              ],
        afternoon:
          day === durationDays
            ? [
                'Mua quà địa phương và chuẩn bị rời đi',
                'Kiểm tra lại hành lý, giấy tờ và phương tiện',
              ]
            : ['Thêm một trải nghiệm văn hóa hoặc thiên nhiên', 'Nghỉ giữa buổi để giữ sức'],
        evening:
          day === 1
            ? [`Ăn ${food}`, 'Dạo khu trung tâm hoặc bờ biển/phố chính']
            : [`Thử ${secondFood}`, 'Tổng kết chi phí và cập nhật lịch trình ngày sau'],
