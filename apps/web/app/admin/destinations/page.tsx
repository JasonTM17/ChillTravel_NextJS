...
const EMPTY_FORM: CreateDestinationRequest = {
  ...
  shortDescription: "", bestTimeToVisit: "", imageUrl: "", category: "",
};
...
function DestinationModal({
  ...
  const set = (k: keyof CreateDestinationRequest, v: string) =>
    setForm((p) => ({ ...p, [k]: v }));
      ...
      <div className="w-full max-w-lg rounded-tv bg-white p-6 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="flex justify-end gap-2 pt-2">
            <button type="button" onClick={onClose} className="rounded-lg border px-4 py-2 text-sm font-semibold text-gray-600 hover:bg-gray-50">
              Hủy
            </button>
            <button
              type="submit"
