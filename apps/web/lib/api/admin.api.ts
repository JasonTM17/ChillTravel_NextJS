...
export type { DashboardSummary, RevenueData, BookingStatusCounts, TopTour, Coupon, CreateCouponRequest } from '@vietwander/shared';
...
export const adminApi = {
  dashboard: {
    getSummary: () => api.get<ApiSuccess<DashboardSummary>>('/admin/dashboard/summary'),

    getRevenue: () => api.get<ApiSuccess<RevenueData[]>>('/admin/dashboard/revenue'),

    getBookingsByStatus: () =>
      api.get<ApiSuccess<BookingStatusCounts>>('/admin/dashboard/bookings'),

    getTopTours: () => api.get<ApiSuccess<TopTour[]>>('/admin/dashboard/top-tours'),
  ...
  destinations: {
    ...
    delete: (id: string) => api.delete<ApiSuccess<void>>(`/admin/destinations/${id}`),
  ...
  tours: {
    ...
    create: (data: CreateTourRequest) => api.post<ApiSuccess<Tour>>('/admin/tours', data),

    update: (id: string, data: Partial<CreateTourRequest>) =>
      api.put<ApiSuccess<Tour>>(`/admin/tours/${id}`, data),

    delete: (id: string) => api.delete<ApiSuccess<void>>(`/admin/tours/${id}`),
  },
  ...
  bookings: {
    ...
    getById: (id: string) => api.get<ApiSuccess<Booking>>(`/admin/bookings/${id}`),
  ...
  reviews: {
    ...
    approve: (id: string) => api.put<ApiSuccess<Review>>(`/admin/reviews/${id}/approve`),

    reject: (id: string) => api.put<ApiSuccess<Review>>(`/admin/reviews/${id}/reject`),

    hide: (id: string) => api.put<ApiSuccess<Review>>(`/admin/reviews/${id}/hide`),
  },
  ...
  blogs: {
    ...
    create: (data: CreateBlogRequest) => api.post<ApiSuccess<BlogPost>>('/admin/blogs', data),

    update: (id: string, data: Partial<CreateBlogRequest>) =>
      api.put<ApiSuccess<BlogPost>>(`/admin/blogs/${id}`, data),

    delete: (id: string) => api.delete<ApiSuccess<void>>(`/admin/blogs/${id}`),
  },
  ...
  contacts: {
    ...
    ) => api.put<ApiSuccess<ContactRequest>>(`/admin/contact-requests/${id}/status`, data),
  },
  ...
  coupons: {
    ...
    create: (data: CreateCouponRequest) => api.post<ApiSuccess<Coupon>>('/admin/coupons', data),

    update: (id: string, data: Partial<CreateCouponRequest>) =>
      api.put<ApiSuccess<Coupon>>(`/admin/coupons/${id}`, data),

    delete: (id: string) => api.delete<ApiSuccess<void>>(`/admin/coupons/${id}`),
  },

  uploads: {
    uploadImage: (formData: FormData) =>
      api.upload<ApiSuccess<{ url: string; filename: string }>>('/admin/uploads/images', formData),
  },
