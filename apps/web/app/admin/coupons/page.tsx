...
function ActiveBadge({ isActive }: { isActive: boolean }) {
  return (
    <span
      className={`rounded-full px-2 py-0.5 text-xs font-semibold ${isActive ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600'}`}
    >
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                onChange={(e) => setNum('minOrderAmount', e.target.value)}
              />
            </div>
            <div>
              <label className="mb-1 block text-xs font-semibold text-gray-600">
              ...
              <input
                ...
                onChange={(e) => setNum('maxDiscountAmount', e.target.value)}
              />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                onChange={(e) => setNum('usageLimit', e.target.value)}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setStr('validFrom', e.target.value)}
                required
              />
            </div>
          </div>
