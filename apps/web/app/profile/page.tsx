...
export default function Page() {
  return (
    <PageShell eyebrow="VIETWANDER AI" title="Profile">
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        <section className="rounded-2xl bg-white p-6 shadow-sm">
          <p className="text-lg text-navy/75">Travel style, demo bookings, reviews, settings, language, and offline travel pack preferences.</p>
