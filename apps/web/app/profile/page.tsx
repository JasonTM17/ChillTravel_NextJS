...
function EditProfileForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label className="block text-sm font-black text-[#071827] mb-1">
          Họ và tên
        </label>
        <input
          type="text"
          ...
          className="w-full rounded-xl border border-[#d9ecfb] bg-[#f7fbff] px-4 py-3 text-sm font-bold text-[#071827] focus:outline-none focus:ring-2 focus:ring-[#0277d4]"
      ...
      <button
        type="submit"
        disabled={saving}
        className="rounded-2xl bg-[#0277d4] px-6 py-3 text-sm font-black text-white disabled:opacity-60"
      >
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <div className="relative">
          <input
            ...
            className="w-full rounded-xl border border-[#d9ecfb] bg-[#f7fbff] px-4 py-3 pr-12 text-sm font-bold text-[#071827] focus:outline-none focus:ring-2 focus:ring-[#0277d4]"
          ...
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 text-[#6f8594]"
      ...
      <button
        type="submit"
        disabled={saving}
        className="rounded-2xl bg-[#ff6d1a] px-6 py-3 text-sm font-black text-white disabled:opacity-60"
      >
    ...
    >
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_340px]">
        <section className="space-y-6">
            ...
            <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-[#476273]">{user.email}</p>
                  {user.phone && (
                    <p className="mt-0.5 text-sm text-[#476273]">{user.phone}</p>
                  )}
                </div>
              </div>
              <button
                ...
                className="flex items-center gap-2 rounded-2xl border border-[#d9ecfb] bg-white px-4 py-3 text-sm font-black text-[#0277d4]"
              >
          ...
          {editMode && (
            <CommerceSurface>
              <h2 className="text-xl font-black mb-5">Cập nhật thông tin</h2>
              <EditProfileForm
          ...
          <CommerceSurface>
            <div className="flex items-center gap-3 mb-5">
              <Lock size={20} className="text-[#0277d4]" aria-hidden="true" />
