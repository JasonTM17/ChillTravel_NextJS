...
- Palette: booking blue #0277D4 for active navigation and trust, deep navy #071827 for text, pale sky #EAF7FF and white surfaces, action orange #FF6D1A for primary conversion CTAs, teal #0F8B7B for safe/local RAG trust badges.
...
- Style: clean, trustworthy, practical travel-commerce product; fewer automation buzzwords, no neon, no sci-fi glass, no decorative orbs.
...
7. Smart planner: warm helper module in Vietnamese: gợi ý lịch trình, ngân sách, văn hóa, ẩm thực; state that live flight/visa/weather data is not available.

**OUTPUT GOAL:**
Make this feel like a production Vietnamese travel booking product, not a generic assistant template. Use real destination photography placeholders and precise Vietnamese microcopy throughout.

## Web landing
Create a premium cinematic travel-commerce web app landing page for CHILLTRAVEL, a Vietnam and world travel platform. Visual identity: emerald teal #0F8B7B, sunset orange #F97316, deep navy #071827, ivory sand #F8F3EA. Include a full-bleed cinematic hero, hero search bar labeled Ban muon di dau, smart trip planner CTA, Vietnam destinations, world bucket list, local experiences, budget simulator, chatbot assistant, mobile app preview, clean booking cards, map-inspired layout, responsive desktop and mobile behavior, modern travel-commerce aesthetic. No third-party logos.

## Mobile
Create a Flutter mobile app UI for CHILLTRAVEL, a premium smart travel planner. Include onboarding, home, explore, destination detail, chat planner, itinerary timeline, booking mock payment, wishlist, profile. Style: cinematic travel, clean cards, emerald teal, sunset orange, deep navy, rounded cards, beautiful imagery, high-end product design.
...
- Direction: Premium editorial travel, not an obvious assistant dashboard.
- Implementation rules:
  - Use real destination photography and strong editorial hierarchy.
  - Keep assistant language secondary; prefer planner, concierge, dossier, route, and mood.
...
- Direction: ChillTravel Editorial, a premium Vietnamese travel planning landing page that feels more like a human-curated planning desk than a generic assistant template.
- Implementation rules:
  - Lead with a generated photographic Vietnam hero and keep the search command in the first viewport.
  - Use route dossier, planning desk, culture guard, budget dial, and offline pack language before generic assistant wording.
...
- Local artifacts were discarded because they were reference-only and must not ship third-party marks.
