        ...
        children: [
          Container(
            ...
            child: const Column(
              ...
              children: [
                Text('Destination Detail', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.w800)),
                SizedBox(height: 12),
                Text('Gallery, overview, things to do, Ask AI, save, add to trip', style: TextStyle(color: Colors.white70, fontSize: 16)),
              ],
            ),
          ),
          ...
          const SizedBox(height: 20),
          FilledButton(onPressed: () => context.go('/chat'), child: const Text('Continue')),
        ],
      ),
    );
  }
