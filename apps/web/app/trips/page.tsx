...
export default function Page() {
  return (
    <PageShell eyebrow="VIETWANDER AI" title="Trip Timeline">
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        <section className="rounded-2xl bg-white p-6 shadow-sm">
          <p className="text-lg text-navy/75">Saved public-share trip stories with editable morning, afternoon, and evening itinerary cards.</p>
