...
export default function Page() {
  return (
    <PageShell eyebrow="VIETWANDER AI" title="Admin Bookings">
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        <section className="rounded-2xl bg-white p-6 shadow-sm">
          <p className="text-lg text-navy/75">Mock booking statuses, demo payment warnings, QR ticket review, and cancellation flows.</p>
