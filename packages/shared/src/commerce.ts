...
export const hotelProperties: HotelProperty[] = [
  {
    ...
    summary: "Khách sạn mẫu theo phong cách boutique, thuận tiện cho lịch biển, ẩm thực và Hội An trong ngày.",
    amenities: ["Hồ bơi", "Ăn sáng mẫu", "Gần biển", "Gói offline", "Hỗ trợ gia đình", "Không lưu thẻ thật"],
    policies: ["Hủy demo miễn phí trước ngày đi", demoPaymentWarning, "Giá và phòng là dữ liệu mẫu local"],
    imageTone: "beach",
    rooms: [
      {
        id: "room-dad-deluxe",
  ...
  },
  {
    ...
    amenities: ["Xe đạp mẫu", "Gần phố cổ", "Bữa sáng địa phương", "Culture guard", "Hỗ trợ offline"],
    policies: ["Không phát sinh giao dịch thật", "Không yêu cầu thẻ thật", "Thông tin phòng là dữ liệu demo"],
    imageTone: "heritage",
    rooms: [
      {
        id: "room-han-river",
...
export const supportArticles: SupportArticle[] = [
  {
    ...
    steps: ["Chọn phương thức demo", "Xác nhận giữ chỗ mẫu", "Nhận mã QR demo", "Không nhập hoặc lưu thẻ thật"]
  },
  {
    id: "support-local-assistant",
    category: "assistant",
    title: "Trợ lý local-first có dữ liệu real-time không?",
    summary: "Trợ lý dùng dữ liệu mẫu/local và phải nói rõ khi không có giá vé bay, visa hoặc thời tiết hiện tại.",
    steps: ["Hỏi lịch trình hoặc ngân sách", "Nhận câu trả lời có citation local", "Kiểm tra nguồn chính thức cho dữ liệu live"]
  },
  {
    id: "support-offline-pack",
    category: "mobile",
    title: "Gói offline lưu những gì?",
    summary: "Mobile lưu lịch trình, yêu thích, booking demo và checklist an toàn trong cache local.",
