...
export default function Page() {
  return (
    <PageShell eyebrow="VIETWANDER AI" title="Map Discovery">
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        <section className="rounded-2xl bg-white p-6 shadow-sm">
          <p className="text-lg text-navy/75">Clustered mock markers, style filters, card previews, and route fallback when no map API is configured.</p>
