...
export default function Page() {
  return (
    <PageShell eyebrow="VIETWANDER AI" title="AI Compare">
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        <section className="rounded-2xl bg-white p-6 shadow-sm">
          <p className="text-lg text-navy/75">Compare Đà Nẵng, Bali, Phuket or any 2-4 destinations by budget, season, food, safety, and AI fit score.</p>
