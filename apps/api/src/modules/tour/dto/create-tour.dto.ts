...
export class CreateTourDto {
  ...
  @ApiPropertyOptional({ description: "Sale price in VND (null = no sale)", minimum: 0, example: 1990000 })
  @IsOptional()
  @IsNumber()
  @Min(0)
  salePrice?: number;
  ...
  @ApiPropertyOptional({ description: "Minimum number of guests", default: 1, minimum: 1, example: 2 })
  @IsOptional()
  @IsInt()
  @Min(1)
  minGuests?: number;
  ...
  @ApiPropertyOptional({ description: "Whether this tour is featured on the homepage", default: false })
  @IsOptional()
  @IsBoolean()
  featured?: boolean;

  @ApiPropertyOptional({ description: "Primary image URL", example: "https://example.com/tour.jpg" })
  @IsOptional()
  @IsString()
  imageUrl?: string;

  @ApiPropertyOptional({ description: "Tour category (e.g. Adventure, Cultural, Beach)", example: "Cultural" })
  @IsOptional()
  @IsString()
  category?: string;
}
