...
export const destinations: Destination[] = [
  {
    ...
    budgetMax: 2200000,
    currency: 'VND',
    travelStyles: ['culture', 'culture', 'family'],
    tags: ['culture', 'AI recommended', 'Vietnam'],
    latitude: 10,
    longitude: 105,
    safetyLevel: 'medium',
    cultureNotes: [
    ...
    isFeatured: true,
    imagePrompt:
      'Premium cinematic travel poster for Hà Nội, Việt Nam, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    budgetMax: 3200000,
    currency: 'VND',
    travelStyles: ['beach', 'food', 'couple'],
    tags: ['beach', 'AI recommended', 'Vietnam'],
    latitude: 11.2,
    longitude: 105.7,
    safetyLevel: 'high',
    cultureNotes: [
    ...
    foodHighlights: ['Chả mực', 'hải sản vịnh'],
    ratingAvg: 4.5,
    reviewCount: 157,
    isFeatured: true,
    imagePrompt:
      'Premium cinematic travel poster for Hạ Long, Việt Nam, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    budgetMax: 2600000,
    currency: 'VND',
    travelStyles: ['mountain', 'culture', 'couple'],
    tags: ['mountain', 'AI recommended', 'Vietnam'],
    latitude: 12.4,
    longitude: 106.4,
    safetyLevel: 'high',
    cultureNotes: [
    ...
    isFeatured: true,
    imagePrompt:
      'Premium cinematic travel poster for Sapa, Việt Nam, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    budgetMax: 1800000,
    currency: 'VND',
    travelStyles: ['nature', 'food', 'family'],
    tags: ['nature', 'AI recommended', 'Vietnam'],
    latitude: 13.6,
    longitude: 107.1,
    safetyLevel: 'high',
    cultureNotes: [
    ...
    foodHighlights: ['Cơm cháy', 'dê núi'],
    ratingAvg: 4.7,
    reviewCount: 231,
    isFeatured: true,
    imagePrompt:
      'Premium cinematic travel poster for Ninh Bình, Việt Nam, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    budgetMax: 2100000,
    currency: 'VND',
    travelStyles: ['culture', 'culture', 'couple'],
    tags: ['culture', 'AI recommended', 'Vietnam'],
    latitude: 14.8,
    longitude: 107.8,
    safetyLevel: 'high',
    ...
    foodHighlights: ['Bún bò Huế', 'cơm hến'],
    ratingAvg: 4.7,
    reviewCount: 268,
    isFeatured: true,
    imagePrompt:
      'Premium cinematic travel poster for Huế, Việt Nam, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
      'Huế local food walk',
  ...
  },
  {
    ...
    foodHighlights: ['Mì Quảng', 'bánh tráng cuốn thịt heo'],
    ratingAvg: 4.8,
    reviewCount: 305,
    isFeatured: true,
    imagePrompt:
      'Premium cinematic travel poster for Đà Nẵng, Việt Nam, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    foodHighlights: ['Cao lầu', 'bánh mì', 'hoành thánh'],
    ratingAvg: 4.9,
    reviewCount: 342,
    isFeatured: true,
    imagePrompt:
      'Premium cinematic travel poster for Hội An, Việt Nam, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    foodHighlights: ['Bún cá', 'nem nướng'],
    ratingAvg: 4.5,
    reviewCount: 379,
    isFeatured: true,
    imagePrompt:
      'Premium cinematic travel poster for Nha Trang, Việt Nam, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    foodHighlights: ['Lẩu gà lá é', 'bánh căn'],
    ratingAvg: 4.5,
    reviewCount: 416,
    isFeatured: true,
    imagePrompt:
      'Premium cinematic travel poster for Đà Lạt, Việt Nam, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    budgetMax: 4200000,
    currency: 'VND',
    travelStyles: ['island', 'food', 'family'],
    tags: ['island', 'AI recommended', 'Vietnam'],
    ...
    foodHighlights: ['Gỏi cá trích', 'hải sản', 'tiêu'],
    ratingAvg: 4.6,
    reviewCount: 453,
    isFeatured: true,
    imagePrompt:
      'Premium cinematic travel poster for Phú Quốc, Việt Nam, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    budgetMax: 1600000,
    currency: 'VND',
    travelStyles: ['food', 'culture', 'couple'],
    tags: ['food', 'AI recommended', 'Vietnam'],
    latitude: 22,
    longitude: 112,
    safetyLevel: 'medium',
    cultureNotes: [
    ...
    foodHighlights: ['Lẩu mắm', 'bánh xèo miền Tây'],
    ratingAvg: 4.7,
    reviewCount: 490,
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for Cần Thơ, Việt Nam, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    budgetMax: 2500000,
    currency: 'VND',
    travelStyles: ['adventure', 'food', 'couple'],
    tags: ['adventure', 'AI recommended', 'Vietnam'],
    latitude: 23.2,
    longitude: 112.7,
    safetyLevel: 'high',
    cultureNotes: [
    ...
    foodHighlights: ['Thắng dền', 'cháo ấu tẩu'],
    ratingAvg: 4.7,
    reviewCount: 527,
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for Hà Giang, Việt Nam, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    budgetMax: 8000000,
    currency: 'VND',
    travelStyles: ['city', 'culture', 'family'],
    tags: ['city', 'AI recommended', 'World'],
    latitude: 24.4,
    longitude: 113.4,
    safetyLevel: 'high',
    cultureNotes: [
    ...
    foodHighlights: ['Sushi', 'ramen', 'izakaya'],
    ratingAvg: 4.8,
    reviewCount: 564,
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for Tokyo, Nhật Bản, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    foodHighlights: ['BBQ', 'tteokbokki', 'bibimbap'],
    ratingAvg: 4.9,
    reviewCount: 601,
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for Seoul, Hàn Quốc, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    currency: 'VND',
    travelStyles: ['food', 'culture', 'couple'],
    tags: ['food', 'AI recommended', 'World'],
    latitude: 26.8,
    longitude: 114.8,
    safetyLevel: 'high',
    cultureNotes: [
    ...
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for Bangkok, Thái Lan, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    budgetMax: 7000000,
    currency: 'VND',
    travelStyles: ['family', 'food', 'family'],
    tags: ['family', 'AI recommended', 'World'],
    latitude: 28,
    longitude: 115.5,
    safetyLevel: 'medium',
    cultureNotes: [
    ...
    foodHighlights: ['Laksa', 'chicken rice', 'chili crab'],
    ratingAvg: 4.5,
    reviewCount: 675,
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for Singapore, Singapore, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    budgetMax: 5200000,
    currency: 'VND',
    travelStyles: ['wellness', 'culture', 'couple'],
    tags: ['wellness', 'AI recommended', 'World'],
    latitude: 29.2,
    longitude: 116.2,
    safetyLevel: 'high',
    cultureNotes: [
    ...
    foodHighlights: ['Babi guling', 'nasi campur'],
    ratingAvg: 4.6,
    reviewCount: 712,
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for Bali, Indonesia, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    budgetMax: 9500000,
    currency: 'VND',
    travelStyles: ['romance', 'food', 'couple'],
    tags: ['romance', 'AI recommended', 'World'],
    latitude: 30.4,
    longitude: 116.9,
    safetyLevel: 'high',
    cultureNotes: [
    ...
    foodHighlights: ['Croissant', 'steak frites', 'patisserie'],
    ratingAvg: 4.7,
    reviewCount: 749,
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for Paris, Pháp, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    currency: 'VND',
    travelStyles: ['culture', 'culture', 'family'],
    tags: ['culture', 'AI recommended', 'World'],
    ...
    foodHighlights: ['Carbonara', 'gelato', 'espresso'],
    ratingAvg: 4.7,
    reviewCount: 786,
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for Rome, Ý, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    budgetMax: 7800000,
    currency: 'VND',
    travelStyles: ['nightlife', 'food', 'couple'],
    tags: ['nightlife', 'AI recommended', 'World'],
    latitude: 32.8,
    longitude: 118.3,
    safetyLevel: 'high',
    cultureNotes: [
    ...
    foodHighlights: ['Tapas', 'paella', 'crema catalana'],
    ratingAvg: 4.8,
    reviewCount: 823,
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for Barcelona, Tây Ban Nha, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    foodHighlights: ['Sunday roast', 'fish and chips'],
    ratingAvg: 4.9,
    reviewCount: 860,
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for London, Anh, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    foodHighlights: ['Pizza', 'bagel', 'deli classics'],
    ratingAvg: 4.5,
    reviewCount: 897,
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for New York, Mỹ, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    currency: 'VND',
    travelStyles: ['mountain', 'culture', 'couple'],
    tags: ['mountain', 'AI recommended', 'World'],
    latitude: 36.4,
    longitude: 120.4,
    safetyLevel: 'high',
    cultureNotes: [
    ...
    foodHighlights: ['Fondue', 'rösti', 'chocolate'],
    ratingAvg: 4.5,
    reviewCount: 934,
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for Swiss Alps, Thụy Sĩ, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    budgetMax: 12000000,
    currency: 'VND',
    travelStyles: ['island', 'food', 'couple'],
    tags: ['island', 'AI recommended', 'World'],
    ...
    foodHighlights: ['Fava', 'seafood', 'Assyrtiko wine'],
    ratingAvg: 4.6,
    reviewCount: 971,
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for Santorini, Hy Lạp, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    budgetMax: 9500000,
    currency: 'VND',
    travelStyles: ['coast', 'culture', 'family'],
    tags: ['coast', 'AI recommended', 'World'],
    latitude: 38.8,
    longitude: 121.8,
    safetyLevel: 'high',
    cultureNotes: [
    ...
    foodHighlights: ['Seafood', 'meat pie', 'brunch'],
    ratingAvg: 4.7,
    reviewCount: 1008,
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for Sydney, Úc, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
  ...
  },
  {
    ...
    budgetMax: 12500000,
    currency: 'VND',
    travelStyles: ['luxury', 'food', 'couple'],
    tags: ['luxury', 'AI recommended', 'World'],
    latitude: 40,
    longitude: 122.5,
    safetyLevel: 'medium',
    cultureNotes: [
    ...
    foodHighlights: ['Machboos', 'mezze', 'luxury dining'],
    ratingAvg: 4.7,
    reviewCount: 1045,
    isFeatured: false,
    imagePrompt:
      'Premium cinematic travel poster for Dubai, UAE, no text, no logo, editorial realistic style, emerald teal and sunset orange grading.',
    experiences: [
